...
def directory_crawler(directory_to_crawl: str = "Refactory/Reference_Scripts/Tests/") -> dict:
    """
...
results_path = os.path.join(os.getcwd(), "Refactory", "Reference_Scripts", "Tests", "greedy_NDS_mut_all_results.csv")

...
#str = "HumanEval/Testing_HumanEval"
def directory_crawler(directory_to_crawl: str = "StudentEval/Reference_Scripts/Tests/") -> dict:
    """
...
def filter_greedily(script_dirs: list, assert_dict: dict) -> list:
    ...
    # )
    results_path = os.path.join(
        os.getcwd(), "StudentEval", "Reference_Scripts", "Tests", "greedy_NDS_mut_all_results.csv"
    )
...
#results_path = os.path.join(os.getcwd(), "HumanEval", "Testing_HumanEval", "greedy_NDS_mut_all_results.csv")
results_path = os.path.join(os.getcwd(), "StudentEval", "Reference_Scripts", "Tests", "greedy_NDS_mut_all_results.csv")
results_file = open(results_path, "w")
results_file.write("test_script_name,number_of_remaining_asserts,\n")
results_file.close()

test_and_mutant_dict = directory_crawler()
all_test_scripts = []
